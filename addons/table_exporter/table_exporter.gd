...
## 点击后把 data/ 下的所有 CSV 导出为 Resources/Tables/ 下的 .tres。


const CsvExporter = preload("res://addons/table_exporter/csv_exporter.gd")

const MENU_NAME := "导表：CSV → .tres"
...
func _enter_tree() -> void:
	_button = Button.new()
	_button.text = "导表"
	_button.tooltip_text = "将 data/ 下的 CSV 导出为 Resources/Tables/ 下的 .tres"
